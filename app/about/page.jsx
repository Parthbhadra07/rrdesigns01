            ...
            <div className="container ">
                <div className="py-4 lg:py-14">
                    ...
                    <p className="text-2xl font-medium lg:w-1/2">
                        The RR Designs is an  interior design company that provides interior design services for homes, offices, apartments, and others. We provide the best interior design services for you. We have a team that is experienced in the field of interior.
                    </p>
                </div>
