            ...
            <div className="grid lg:grid-cols-2 place-items-center ">
                ...
                <div className="items-center">
                    <p className="px-12 pb-4 ">
                        RR Designs is a company engaged in the field of interior design. We provide the best interior design for your home. We have been trusted by many people to design their homes. We have also received many awards from various countries for our work.
                    </p>
